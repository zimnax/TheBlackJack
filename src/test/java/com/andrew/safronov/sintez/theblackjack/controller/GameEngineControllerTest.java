...
public class GameEngineControllerTest {
	...
	// @Test
	// public void doBetCheckBetCoinsSum() throws Exception {
	//
	// MockHttpServletRequestBuilder initPlayerResult =
	// get("/purse/initDefaultPlayer").accept(MediaType.ALL);
	// mockMvcPlayerController.perform(initPlayerResult);
	//
	// MockHttpServletRequestBuilder doBetResult = get("/action/1/bet/" +
	// randomBetSum).accept(MediaType.ALL);
	// ResultActions betResults =
	// mockMvcGameEngineController.perform(doBetResult);
	//
	// betResults.andExpect(jsonPath("$.bet").value(Integer.parseInt(randomBetSum)));
	// }

	// @Test
	// public void doBetCheckLogsBetCoinsSum() throws Exception {
	//
	// MockHttpServletRequestBuilder initPlayerResult =
	// get("/purse/initDefaultPlayer").accept(MediaType.ALL);
	// mockMvcPlayerController.perform(initPlayerResult);
	...
	// mockMvcGameEngineController.perform(doBetResult);
	//
	// betResults.andExpect(jsonPath("$.purse.game.gameLogs[*].action").value(GameActions.BET.getAction()));
	//
	// }
